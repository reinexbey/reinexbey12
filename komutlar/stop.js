...
const youtube = new YouTube("AIzaSyAzpzT_-NgBfeGhe99X3QXY6e4B4uxjuqc");
...
exports.run = async (client, message, args) => {
  ...
  if (!message.member.hasPermission("KİCK_MEMBERS"))
    return message.reply(
      ":x: **This command requires you to either have a role named** `DJ` **or** `Manage Channels` **permission to use it** (being alone with the bot also works)"
    );
};
